        ...
        <div class="hero-details-container">
          <div class="hero-details-content">
            <div class="breadcrumb-modern">
              <router-link to="/search" class="breadcrumb-link">{{ t('search.searchVehicles') }}</router-link>
              <span class="breadcrumb-separator">›</span>
              <span class="breadcrumb-current">{{ vehicle?.brand_name }} {{ vehicle?.model }}</span>
            </div>
...
import GallerySection from '../components/vehicleDetails/GallerySection.vue'
import ContentGridSection from '../components/vehicleDetails/ContentGridSection.vue'
import ReviewsSection from '../components/vehicleDetails/ReviewsSection.vue'
import SimilarVehicleSection from '../components/vehicleDetails/SimilarVehicleSection.vue'
import {
  EnvironmentOutlined,
  CalendarOutlined,
  CheckCircleFilled,
...
const subtotal = computed(() => {
  return (vehicle.value?.daily_rate || 0) * totalDays.value
})

const taxes = computed(() => {
  return subtotal.value * 0.02 // 10% taxes
})
...
const handleBooking = async () => {
  ...
  try {
    ...
    console.log('Booking vehicle:', vehicle.value.id, bookingDates.value)
...
const contactOwner = () => {
  ...
  console.log('Contacting owner for vehicle:', vehicle.value.id)
}
